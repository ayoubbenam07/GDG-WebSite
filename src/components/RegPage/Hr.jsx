    ...
    return(
        ...
        <div className="form">
            ...
            <form id="RegestrationForm" className="flex flex-col justify-between gap-2">
                ...
                <textarea value={data.Q1} onChange={(e) => onChange("Q2", e.target.value)} required ref={textarea1Ref} onInput={() => handleInput(textarea1Ref)} type="text" placeholder="Explain..." className="input"/><br />
                <label htmlFor="" className="labelText">How would you help keep members motivated and engaged?</label>
                <textarea value={data.Q2} onChange={(e) => onChange("Q2", e.target.value)} required ref={textarea2Ref} onInput={() => handleInput(textarea2Ref)}  type="text" placeholder="Explain..." className="input"/><br />
                ...
                <textarea value={data.Q3} onChange={(e) => onChange("Q2", e.target.value)}  required ref={textarea3Ref} onInput={() => handleInput(textarea3Ref)}  type="text" placeholder="Explain..." className="input"/><br />
            </form>
